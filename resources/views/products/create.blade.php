        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="name" id="name" class="form-control" required autofocus  value="">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="barcode" id="barcode" class="form-control" required value="">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <textarea name="description" id="mytextarea" cols="30" rows="3" class='form-control'>
